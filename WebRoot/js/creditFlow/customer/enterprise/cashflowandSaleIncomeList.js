	...
	var getcashflowandSaleIncomeData = function(grid) {
	...
	cashflowandSaleIncomeList = Ext.extend(Ext.Panel,{
		layout : 'anchor',
		anchor : '100%',
		personId :null,
		isHidden:false,
		...
		constructor : function(_cfg) {
			...
			cashflowandSaleIncomeList.superclass.constructor.call(this,
					{
						items : [ this.grid_cashflowandSaleIncomeInfo ]
					})
		},
					...
					hidden : true
													...
													editor : {
														...
														readOnly : this.isReadOnly
																																												...
																																												,{
													header : '主营业务收入',	
													dataIndex : 'mainBusinessIncomeMoney',
													sortable : true,
													editor : {
														xtype : 'numberfield',
														readOnly : this.isReadOnly
					...
					if (btn == "yes") {
						...
						for ( var i = 0; i < s.length; i++) {
							...
							if (row.data.cashflowAndSaleIncomeId == null || row.data.cashflowAndSaleIncomeId == '') {
								...
								deleteFun(
										__ctxPath + '/creditFlow/customer/enterprise/multiDelBpCustEntCashflowAndSaleIncome.do',
										{
