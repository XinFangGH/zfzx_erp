 ...
 * @company 智维软件
 */
LeaseFinanceMaterialsForm = Ext.extend(Ext.Window, {
	        projId:null,
	        operateObj:null,
	        extPanel:null,
	        businessType:null,
			...
			constructor : function(_cfg) {
				...
				LeaseFinanceMaterialsForm.superclass.constructor.call(this, {
							layout : 'fit',
							modal : true,
							height : 400,
							items : this.extPanel,
			...
			initUIComponents : function() {
				if(this.isShow==true){
				 ...
				 var url=__ctxPath+ '/materials/listTreeByOperationTypeKeyGlobalGuaranteeMaterialsExt.do?operationTypeKey=LeaseFinance_DirectLeaseFinance';
				 if(this.isShow==true){
				        	url=__ctxPath + '/materials/listTreeGlobalGuaranteeMaterialsDetail.do?operationTypeKey=LeaseFinance_DirectLeaseFinance'
				 }
			...
			save : function() {
			    ...
			    Ext.Ajax.request({
					url : __ctxPath + '/materials/updateMaterialsGlobalGuaranteeMaterialsExt.do',
					method : 'POST',
					scope : this,
					success : function(response, request) {
						this.operateObj.store.setBaseParam('projId',this.projId)//add by gaoqingrui  
