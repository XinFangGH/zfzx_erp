...
ReportMenuFinancingprojectAchievement = function(_cfg) {
	...
	return ReportPreviewFinancingprojectAchievement(this.reportId, this.title,this.reportKey,this.projectMoney,this.projectMoneyl,
