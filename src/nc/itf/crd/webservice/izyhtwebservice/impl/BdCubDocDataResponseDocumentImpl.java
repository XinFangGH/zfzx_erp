 ...
 */
public class BdCubDocDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.BdCubDocDataResponseDocument
{
    
    public BdCubDocDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName BDCUBDOCDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "bdCubDocDataResponse");
    
    
    /**
     * Gets the "bdCubDocDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.BdCubDocDataResponseDocument.BdCubDocDataResponse getBdCubDocDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.BdCubDocDataResponseDocument.BdCubDocDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.BdCubDocDataResponseDocument.BdCubDocDataResponse)get_store().find_element_user(BDCUBDOCDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setBdCubDocDataResponse(nc.itf.crd.webservice.izyhtwebservice.BdCubDocDataResponseDocument.BdCubDocDataResponse bdCubDocDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.BdCubDocDataResponseDocument.BdCubDocDataResponse)get_store().add_element_user(BDCUBDOCDATARESPONSE$0);
            }
            target.set(bdCubDocDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.BdCubDocDataResponseDocument.BdCubDocDataResponse addNewBdCubDocDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class BdCubDocDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.BdCubDocDataResponseDocument.BdCubDocDataResponse
    {
        
        public BdCubDocDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
