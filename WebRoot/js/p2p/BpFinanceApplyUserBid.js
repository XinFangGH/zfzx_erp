 ...
 * @createtime:
 */
BpFinanceApplyUserBid = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpFinanceApplyUserBid.superclass.constructor.call(this, {
							id : 'BpFinanceApplyUserBid',
							title : '已发标',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel=new HT.GridPanel({
					...
					url : __ctxPath + "/p2p/personListBpFinanceApplyUser.do?state=10",
					fields : [{
									name : 'loanId',
									type : 'int'
								}
