 ...
 */
public class AccGrantDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.AccGrantDataResponseDocument
{
    
    public AccGrantDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ACCGRANTDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "accGrantDataResponse");
    
    
    /**
     * Gets the "accGrantDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.AccGrantDataResponseDocument.AccGrantDataResponse getAccGrantDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.AccGrantDataResponseDocument.AccGrantDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.AccGrantDataResponseDocument.AccGrantDataResponse)get_store().find_element_user(ACCGRANTDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAccGrantDataResponse(nc.itf.crd.webservice.izyhtwebservice.AccGrantDataResponseDocument.AccGrantDataResponse accGrantDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.AccGrantDataResponseDocument.AccGrantDataResponse)get_store().add_element_user(ACCGRANTDATARESPONSE$0);
            }
            target.set(accGrantDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.AccGrantDataResponseDocument.AccGrantDataResponse addNewAccGrantDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class AccGrantDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.AccGrantDataResponseDocument.AccGrantDataResponse
    {
        
        public AccGrantDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
