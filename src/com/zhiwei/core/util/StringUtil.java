...
//    }
	 ...
	 * @return
	 */
	public static boolean checkExtType(String extName){
		boolean extType = false;
		if(extName!=null&&!extName.equals("")){
			int lastNum = extName.lastIndexOf(".");
	        String ext =extName.substring(lastNum);
	 ...
	 * @return
	 */
	public static String checkExtName(String extName){
		if(extName!=null&&!extName.equals("")){
			extName = extName.replace("<", "").replace(">", "").replace("=", "")
							.replace(" ", "").replace("/", "").replace("\\", "")
							.replace("(", "").replace(")", "").replace(".jsp", "")
							.replace(".js", "").replace(".exe", "").replace(".rar", "");
		}
		return extName;
	}
}
