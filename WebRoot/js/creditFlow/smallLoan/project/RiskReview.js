 ...
 * @createtime:
 */
RiskReview = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		RiskReview.superclass.constructor.call(this, {
			id : 'RiskReview',
			title : '风险审核',
			region : 'center',
			layout : 'border',
			iconCls :'btn-tree-team8',
	...
	initUIComponents : function() {
		...
		this.topbar = new Ext.Toolbar({
			items : [{
						...
						xtype : 'button',
						scope : this,
						//hidden : isGranted('_riskReview_flow') ? false : true,
		...
		this.gridPanel = new HT.GridPanel( {
			...
			notmask :true,
			tbar:this.topbar,
			url : __ctxPath + "/flow/getByProcessNameNodeKeyOfCommonTask.do?processName=smallLoanCommonFlow&flowNodeKey=slcfRiskDepartmentExamine&searchType=byUserId",
			fields : [ {
				name : 'task.taskId',
				type : 'int'
			}, 'task.dueDate',
