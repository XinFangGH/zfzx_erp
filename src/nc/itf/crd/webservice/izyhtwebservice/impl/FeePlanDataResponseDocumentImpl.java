 ...
 */
public class FeePlanDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.FeePlanDataResponseDocument
{
    
    public FeePlanDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName FEEPLANDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "feePlanDataResponse");
    
    
    /**
     * Gets the "feePlanDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.FeePlanDataResponseDocument.FeePlanDataResponse getFeePlanDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.FeePlanDataResponseDocument.FeePlanDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.FeePlanDataResponseDocument.FeePlanDataResponse)get_store().find_element_user(FEEPLANDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setFeePlanDataResponse(nc.itf.crd.webservice.izyhtwebservice.FeePlanDataResponseDocument.FeePlanDataResponse feePlanDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.FeePlanDataResponseDocument.FeePlanDataResponse)get_store().add_element_user(FEEPLANDATARESPONSE$0);
            }
            target.set(feePlanDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.FeePlanDataResponseDocument.FeePlanDataResponse addNewFeePlanDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class FeePlanDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.FeePlanDataResponseDocument.FeePlanDataResponse
    {
        
        public FeePlanDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
