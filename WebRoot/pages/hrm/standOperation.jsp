...
<%@page import="com.zhiwei.credit.service.hrm.StandSalaryService"%>
<%@page import="com.zhiwei.credit.model.hrm.StandSalary"%><table class="table-info" cellpadding="0" cellspacing="1" width="98%" align="center">
