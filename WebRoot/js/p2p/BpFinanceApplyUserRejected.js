 ...
 * @createtime:
 */
BpFinanceApplyUserRejected = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpFinanceApplyUserRejected.superclass.constructor.call(this, {
							id : 'BpFinanceApplyUserRejected',
							title : '用户申请被驳回',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel=new HT.GridPanel({
					...
					url : __ctxPath + "/p2p/personListBpFinanceApplyUser.do?state=3",
					fields : [{
									name : 'loanId',
									type : 'int'
								}
