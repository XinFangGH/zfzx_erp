...
import com.thirdPayInteface.Fuiou.FuiouResponse.FuiouReponse;
import com.thirdPayInteface.Fuiou.FuiouResponse.OpResult;
import com.thirdPayInteface.Fuiou.FuiouResponse.Plain;
import com.thirdPayInteface.Fuiou.FuiouUtil.SecurityUtils;
import com.thirdPayInteface.Fuiou.FuiouUtil.StringUtil;
...
public class FuiouInterfaceUtil {
	 ...
	 * @return
	 */
	private static Map fuiouProperty() {
	 ...
	 * @return
	 */
	public static Object[] balanceQuery(CommonRequst commonRequst){
	 ...
	 * @return
	 */
	public static Object[] preAuthorization(CommonRequst commonRequst){
	 ...
	 * @return
	 */
	public static Object[] preAuthorizationCancel(CommonRequst commonRequst){
	 ...
	 * @return
	 */
	public static Object[] transfers(CommonRequst commonRequst){
		...
		try{
			...
			e.printStackTrace();
			ret[0]=ThirdPayConstants.RECOD_FAILD;
			ret[1]="转账(商户与个人之间)对接失败"+e.getMessage();
			ret[2]=commonResponse;
		}
		return ret;
	}
	 ...
	 * @return
	 */
	public static Object[] allot(CommonRequst commonRequst){
		...
		try{
			...
			e.printStackTrace();
			ret[0]=ThirdPayConstants.RECOD_FAILD;
			ret[1]="划拨 (个人与个人之间)对接失败"+e.getMessage();
			ret[2]=commonResponse;
		}
		return ret;
	}
...
/*	public static Object[] preTransferFreeze(CommonRequst commonRequst){
	 ...
	 * @return
	 */
	public static Object[] rechargeAndWithdraw(CommonRequst commonRequst){
		...
		try{
			...
			if(fuiou!=null){
				...
				fuiou.setCust_no(commonRequst.getThirdPayConfigId());
				//交易状态
				fuiou.setTxn_st(commonRequst.getBusinessStatus());
				//页码
				fuiou.setPage_no(commonRequst.getPageNo());
				//每页条数
				fuiou.setPage_size(commonRequst.getPageSize());
