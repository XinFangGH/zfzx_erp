 ...
 * @extends Ext.Panel
 */
LeaseFinanceProjectInfoEditPanel = Ext.extend(Ext.Panel, {
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		this.initUIComponents();
		LeaseFinanceProjectInfoEditPanel.superclass.constructor.call(this, {
			id : 'LeaseFinanceProjectInfoEdit_' + this.record.data.projectId,// id属性值前缀通过是否包含"Edit"来区分查看和编辑页面
	...
	initUIComponents : function() {
		var jsArr = [
				__ctxPath + '/js/creditFlow/leaseFinance/project/LeaseFinanceProjectInfoEdit.js'// 项目信息
		];
	...
	constructPanel : function() {
		...
		this.projectInfoNavigation = new LeaseFinanceProjectInfoNavigation({
			...
			isCustomerInfoEdit : isGranted('ediCustomer_fl'
					+ this.projectStatus + this.bmStatus),
			flag : "edit" // edit表示编辑页面,see表示查看页面
		});
		// 项目信息
		this.projectInfo = new LeaseFinanceProjectInfoEdit({
			record : this.record,
