 ...
 * @createtime:
 */
MatchFundsSuccessView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		MatchFundsSuccessView.superclass.constructor.call(this, {
					id : 'MatchFundsSuccessView' + this.tabflag,
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			url : onclickflag == 0
					? __ctxPath + '/project/findListSlSmallloanProject.do?projectStatus=4&isGrantedShowAllProjects='+this.isGrantedShowAllProjects
					: null,
			fields : [{
						name : 'projectId',
						type : 'int'
