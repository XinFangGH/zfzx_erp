 ...
 * @createtime:
 */
PlBidSaleTab= Ext.extend(Ext.Panel, {
			// 构造函数
			...
			constructor : function(_cfg) {
				...
				// 调用父类构造
				PlBidSaleTab.superclass.constructor.call(this, {
							id : 'PlBidSaleTab',
							title : '债权交易',
			...
			initUIComponents : function() {
				var itemschange=[
				 new transferedList({listtype:'transferedList'}),
				 new transfereToOrList({listtype:'transfereToOrList'}),
			 	 new transferingList({listtype:'transferingList'}),
			 	 new ingTransferList({listtype:'ingTransferList'}),
			     new closeedList({listtype:'closeedList'})
				];
