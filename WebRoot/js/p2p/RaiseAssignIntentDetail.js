 ...
 * @createtime:
 */
RaiseAssignIntentDetail = Ext.extend(Ext.Window, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				RaiseAssignIntentDetail.superclass.constructor.call(this, {
							id : 'RaiseAssignIntentDetail',
							layout : 'fit',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					// 使用RowActions
					rowActions : false,
					id : 'RaiseAssignIntentDetailGird',
					isautoLoad:true,
					url : __ctxPath + "/creditFlow/financingAgency/getRaiseDetailPlMmOrderAssignInterest.do?planId="+this.planId,
					fields : ['intentDate','factDate','investPersonName','incomeMoney','fundType','buyDatetime','startinInterestTime','days'],
					columns : [{
								header : '奖励用户',
								align : 'center',
