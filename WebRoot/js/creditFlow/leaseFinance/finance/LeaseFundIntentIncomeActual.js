 ...
 * @createtime:
 */
LeaseFundIntentIncomeActual = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		LeaseFundIntentIncomeActual.superclass.constructor.call(this, {
					id : 'LeaseFundIntentIncomeActual'+this.businessType+this.type,
					title : '实收款项',
					region : 'center',
					layout : 'border',
					iconCls : 'btn-team29',
	...
	initUIComponents : function() {
		...
		this.topbar = new Ext.Toolbar({
					items : [
							...
							// scope : this,
							// hidden :
							// isGranted('_liushui_f_'+this.businessType)?false:true,
							...
							// scope : this,
							// hidden :
							// isGranted('_cash_f_'+this.businessType)?false:true,
						...
						hidden : isGranted('_liushuisee_f_interestIncome_'
								+this.businessType+'_'+this.type) ? false : true,
					...
					// if(flag==true){
					// Ext.getCmp("Q_intentDate_D_LE"+tabflag).setValue(new
					// Date);
					// var now=new Date();
					// var time=now.getTime();
					...
					// }
					// },' ',' ',' ',' '
					// ,{xtype:'label',html : '【<font
					// style="line-height:20px">颜色预警：</font>'}
					// ,{xtype:'label',html : '<font
					// color=red>&nbsp;&nbsp未结清项</font>'}
		...
		this.gridPanel = new HT.GridPanel({
			...
			fields : [{
					...
					'status', 'remark', 'faxiAfterMoney', 'businessType',
					'projectId', 'isInitialorId', 'orgName', 'companyId','interestStarTime','interestEndTime'],
			columns : [{
						header : 'fundIntentId',
