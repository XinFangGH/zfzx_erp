 ...
 * @createtime:
 */
SlFundIntentConstBackAlready = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				SlFundIntentConstBackAlready.superclass.constructor.call(this, {
							id : 'SlFundIntentConstBackAlready',
							title : '已退回项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team29',
...
//						,{xtype:'label',html : '&nbsp;&nbsp已结清项】'}
				...
				this.gridPanel = new HT.GridPanel({
					...
					url : __ctxPath + "/creditFlow/finance/listbyLedgerSlFundIntent.do?businessType=SmallLoan&fundType=('constBack')&typetab=actual",
					fields : [{
								name : 'fundIntentId',
								type : 'int'
