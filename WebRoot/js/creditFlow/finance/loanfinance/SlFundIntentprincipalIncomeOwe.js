...
//						,{xtype:'label',html : '&nbsp;&nbsp已结清项】'}
				...
				this.gridPanel = new HT.GridPanel({
					...
					fields : [{
							...
							'fundTypeName', 'intentDate',
							'payMoney', 'payInMoney', 'factDate','fundType',
							'afterMoney', 'notMoney','flatMoney', 'isOverdue',
							'overdueRate', 'accrualMoney', 'status','remark',
							'businessType','projectId','orgName','companyId',
							'continueDates','amountPayable','faxiAfterMoney','continueInterest','continueDay','interestStarTime','interestEndTime','payintentPeriod','ids','bidPlanId'],
					columns : [{
								header : 'fundIntentId',
