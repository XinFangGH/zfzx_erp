 ...
 */
/**
 * PlMmOrderChildrenOr Base Java Bean, base class for the.credit.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 订单与子债权匹配库
 */
public class PlMmOrderChildrenOr extends com.zhiwei.core.model.BaseModel {
	...
	/**
	 * 到期日类型
	 * 1:债权结束日，2:订单结束日，3:都不是,4:提前赎回的日期
	 */
	 ...
	 * 匹配人Id
	 */
	protected Long matchPersonId;
	/**
	 * 匹配人姓名
	 */
	protected String matchPersonName;

	/**
	 * Default Empty Constructor for class PlMmOrderChildrenOr
	 */
	public PlMmOrderChildrenOr () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class PlMmOrderChildrenOr
	 */
	public PlMmOrderChildrenOr (
		 Long in_matchId
        ) {
	...
	public boolean equals(Object object) {
		if (!(object instanceof PlMmOrderChildrenOr)) {
			return false;
		}
		PlMmOrderChildrenOr rhs = (PlMmOrderChildrenOr) object;
