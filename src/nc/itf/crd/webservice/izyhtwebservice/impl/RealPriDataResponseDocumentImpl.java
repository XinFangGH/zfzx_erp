 ...
 */
public class RealPriDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.RealPriDataResponseDocument
{
    
    public RealPriDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName REALPRIDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "realPriDataResponse");
    
    
    /**
     * Gets the "realPriDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.RealPriDataResponseDocument.RealPriDataResponse getRealPriDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.RealPriDataResponseDocument.RealPriDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.RealPriDataResponseDocument.RealPriDataResponse)get_store().find_element_user(REALPRIDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRealPriDataResponse(nc.itf.crd.webservice.izyhtwebservice.RealPriDataResponseDocument.RealPriDataResponse realPriDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.RealPriDataResponseDocument.RealPriDataResponse)get_store().add_element_user(REALPRIDATARESPONSE$0);
            }
            target.set(realPriDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.RealPriDataResponseDocument.RealPriDataResponse addNewRealPriDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class RealPriDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.RealPriDataResponseDocument.RealPriDataResponse
    {
        
        public RealPriDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
