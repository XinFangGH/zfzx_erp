...
Ext.apply(Ext.form.VTypes, {  
			...
			items : [{
					...
					//swj
						...
						items : [{
									...
									// name : 'plBidPlan.addRate',//原版加息利率
									name : 'plBidPlan.showRate',//展示加息利率
									id : 'addRate_text',
									readOnly : this.isReadOnly,
									xtype : 'numberfield',
									anchor : '100%'
                    ...
                    labelAlign : 'right',
                    items : [{
                        hiddenName : 'plBidPlan.versionType',
                        xtype : 'combo',
                        fieldLabel : '标的显示版本',
                        allowBlank : false,
                        editable : false,
	...
	save : function() {
		...
		if(checkaddRate==true){
			var addRate = this.getCmpByName('plBidPlan.showRate').getValue();
			if(addRate==""){
