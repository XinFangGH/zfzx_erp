 ...
 * @createtime:
 */
LeaseFundIntentPrincipalPayAll = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				LeaseFundIntentPrincipalPayAll.superclass.constructor.call(this, {
							id : 'LeaseFundIntentPrincipalPayAll'+this.businessType+this.type,
							title : '全部款项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team29',
...
//					}
					,{
						...
						hidden : isGranted('_liushuisee_fprincipalPay__'+this.businessType+'_'+this.type)?false:true
					}),{
						iconCls : 'btn-ok',
						text :'核销',
						xtype : 'button',
						...
						hidden : (isGranted('_uploaddownpz_f_principalPay_'+this.businessType+'_'+this.type)?false:true)||(isGranted('_previewpz_f_'+this.businessType)?false:true)
					}),{
						iconCls : 'btn-setting',
						text :'预览凭证',
						xtype : 'button',
