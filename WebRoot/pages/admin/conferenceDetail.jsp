...
<%@ page
	import="com.zhiwei.credit.model.admin.Conference,com.zhiwei.credit.model.admin.ConfPrivilege"%>
...
<%@page import="com.zhiwei.core.util.AppUtil"%><table class="table-info"
