...
ReportMenuFinancingproject = function(_cfg) {
	...
	return ReportPreviewFinancingproject(this.reportId, this.title,this.reportKey,this.projectMoney,this.projectMoneyl,
