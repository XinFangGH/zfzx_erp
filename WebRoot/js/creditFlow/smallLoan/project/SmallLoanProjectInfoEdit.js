	...
	this.SlProcreditMaterialsView = new SlEnterPriseProcreditMaterialsView(
		{
			...
			isHidden:isGranted('editProcreditMaterials_' + this.projectStatus),
		...
		this.projectInfoFinance= new ownFund({
			isAllReadOnly:!isGranted('editOwnFund_' + this.projectStatus),
			isReadOnly:!isGranted('editOwnFund_' + this.projectStatus),
			isHiddencalculateBtn:true,
		 	projectId:this.projectId,
		 	isStartDateReadOnly:!isGranted('editOwnFund_' + this.projectStatus),
			idDefinition:'tongyongliucheng1Edit'+this.taskId
		});
		this.gridPanel = new OwnFundIntentView({
			...
			isHiddenTitle:true,
			isHiddenAddBtn:!isGranted('addFundIntentView_' + this.projectStatus),
			isHiddenDelBtn:!isGranted('delFundIntentView_' + this.projectStatus),
			isHiddenautocreateBtn:!isGranted('autoFundIntentView_' + this.projectStatus),
			isHiddenExcel:false,
		...
		this.slActualToCharge = new SlActualToCharge({
			...
			businessType :'SmallLoan',
			isHiddenTitle:true,
			isHidden:!isGranted('editSlActualToCharge_' + this.projectStatus),
		...
		this.dYMortgageViewProduct=new DZYMortgageView({
			...
			isHiddenAddBtn:!isGranted('addMortgage_' + this.projectStatus),
			isHiddenDelBtn:!isGranted('delMortgage_' + this.projectStatus),
			isHiddenEdiBtn:!isGranted('editMortgage_' + this.projectStatus),
			isHiddenRelieve:true,
			isblHidden:false,
			isblEdit:isGranted('editblMortgage__' + this.projectStatus),
			isBl:!isGranted('editblMortgage__' + this.projectStatus),
		...
		this.baozMortgageView= new BaozMortgageView({
			...
			isRecieveHidden:true,
			isblHidden:false,
			isblEdit:isGranted('editblMortgage_' + this.projectStatus),
			isBl:!isGranted('editblMortgage_' + this.projectStatus),
			formPanel:this.LendForm
		})
		this.slContractView=new SlContractView({
		    projectId:this.fundProjectId,
		    isHiddenTbar:!isGranted('editContract_' + this.projectStatus),
		    isHiddenDelBtn:!isGranted('editContract_' + this.projectStatus),
		    isHiddenAddBtn:!isGranted('editContract_' + this.projectStatus),
		    isHiddenEdiBtn:!isGranted('editContract_' + this.projectStatus),
...
this.repaymentSource=new RepaymentSource({
					isHidden:!isGranted('editRepaymentSource_' + this.projectStatus),
					isHiddenAddBtn:!isGranted('editRepaymentSource_' + this.projectStatus),
					isHiddenDelBtn:!isGranted('editRepaymentSource_' + this.projectStatus),
				    projectId:this.projectId
				})
		this.borrowerInfo=new BorrowerInfo({
			projectId : this.projectId,
			isHidden : !isGranted('editBorrowerInfo_' + this.projectStatus),
			isHiddenAddBtn : !isGranted('addBorrowerInfo_' + this.projectStatus),
			isHiddenDelBtn:!isGranted('delBorrowerInfo_' + this.projectStatus)
		});
		this.SlReportView = new SlReportView({
			projectId : this.projectId,
			businessType : 'SmallLoan',
	    	isHidden_report : !isGranted('editReportView_' + this.projectStatus)
		});
		...
		this.outPanel = new Ext.Panel({
			...
			items : [{
				...
				title : '<a name="sl_repaymentSource_edit' + this.projectId
				...
				title : '<a name="sl_borrowerInfo_edit' + this.projectId
