 ...
 * */
   ...
   public void create(List list){
	  SlFundIntent bf=calculslfundintent(ProjectInterestPenalty,this.earlyDate,earlyDate,intentDate,BigDecimal.valueOf(0),earlyProjectMoney.multiply(this.accrual.divide(BigDecimal.valueOf(3000),5,BigDecimal.ROUND_HALF_UP)).multiply(BigDecimal.valueOf(this.penaltyDays)),payintentPeriod);
	   if(bf.getIncomeMoney().compareTo(new BigDecimal(0))!=0){
		   list.add(bf);
	   }
	 //提前还款的金额
		SlFundIntent bf1=calculslfundintent(ProjectLoadRoot,this.earlyDate,beforeDate,earlyDate,BigDecimal.valueOf(0),earlyProjectMoney,payintentPeriod);
