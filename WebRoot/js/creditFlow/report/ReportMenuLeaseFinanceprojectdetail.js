...
ReportMenuLeaseFinanceprojectdetail = function(_cfg) {
	...
	return ReportPreviewGuarnteeprojectdetail(this.reportId, this.title,this.reportKey,this.projectMoney,this.projectMoneyl,
