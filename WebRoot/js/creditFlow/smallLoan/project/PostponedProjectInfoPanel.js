 ...
 * @extends Ext.Panel
 */
PostponedProjectInfoPanel = Ext.extend(Ext.Panel, {
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		this.initUIComponents();
		PostponedProjectInfoPanel.superclass.constructor.call(this, {
	...
	initUIComponents : function() {
		var jsArr = [
				__ctxPath
						+ '/js/creditFlow/smallLoan/project/PostponedProjectInfo.js'// 项目信息
		];
...
*/		});
		// 项目信息
		this.projectInfo = new PostponedProjectInfo({
			record : this.record,
