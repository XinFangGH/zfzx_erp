ProjectInfoPanelah = Ext.extend(Ext.Panel, {
		...
		ExtUD.Ext.McroLoanProjectInfoPanel.superclass.constructor.call(this, {
			items : [{
				...
				items : [
						...
						{
							columnWidth : isGroup=="true"?.117:.3,
							layout : "form", // 从上往下的布局
							...
							items : [{
								...
								fieldLabel : "贷款利息收取单位",
								emptyText : "请选择",
								hidden:isGroup=="true"?true:false,//集团版隐藏
							...
							columnWidth : isGroup=="true"?.483:.3, // 该列在整行中所占的百分比
							layout : "form", // 从上往下的布局
							labelWidth : 1,
							items : [ {
								xtype : "textfield",
							...
							items : [{
								...
								emptyText : "请选择",
								//name:'slSmallloanProject.managementConsultingMineName',
...
Ext.reg('ahbasinfo', ProjectInfoPanelah);
		...
		ProjectInfoPanel.superclass.constructor.call(this, {
			items : [{
				...
				items : [
							...
							items:[{
								...
								items:[{
									...
									items:[{
										xtype:'textfield',
										anchor:'100%',
										name:'slSmallloanProject.availableType',
										fieldLabel:'推介机构类型',
										readOnly:true
									}]
								},{
									...
									items:[{
										...
										anchor:'100%',
										fieldLabel:'机构名称',
										name:'slSmallloanProject.valilableName',
										readOnly:true
									}]
								},{
									layout:'form',
									...
									items:[{
										...
										anchor:'100%',
										fieldLabel:'当前可用额度',
										name:'slSmallloanProject.laveCredit'
									}]
								}]
							}]
						},{
						...
						emptyText : "请选择",
						hiddenName : 'slSmallloanProject.mineName', 
	//					allowBlank : false,
						displayField : 'itemName',
						typeAhead : true,
						readOnly : this.isDiligenceReadOnly,
						...
						listeners : {
							...
							change:function(combox){
            					...
            					this.getCmpByName("slSmallloanProject.mineId").setValue(compID);
							}
						}
...
Ext.reg('whbasinfo', ProjectInfoPanel);
