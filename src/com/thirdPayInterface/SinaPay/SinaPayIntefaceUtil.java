...
import com.thirdPayInterface.SinaPay.SinaPay;
import com.zhiwei.credit.util.UrlUtils;
import com.thirdPayInterface.SinaPay.SinaPayUtil.Base64;
import com.thirdPayInterface.SinaPay.SinaPayUtil.GsonUtil;
import com.thirdPayInterface.SinaPay.SinaPayUtil.MD5;
import com.thirdPayInterface.SinaPay.SinaPayUtil.RSA;
	...
	private static Map sinaPayProperty(){
		...
		try{
			if(thirdPayEnvironmentType.equals(ThirdPayConstants.THIRDENVIRONMENT0)){//正式环境
		        ...
		        InputStream in = Object.class.getResourceAsStream("/com/thirdPayInterface/SinaPay/SinaPayTestEnvironment.properties"); 
		    	props.load(in);
