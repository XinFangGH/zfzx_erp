...
public class CommonRequestInvestRecord {
	...
	private String bidRequestNo;//投标流水号（已经投标成功的流水号）（易宝投标生成的流水号，放款时用此流水号）
	...
	private String QueryRequsetNo;//投标时的流水号
	private String LoanNoList;//批量放款款流水号
	private String preAuthorizationNum;//单个放款款流水号
