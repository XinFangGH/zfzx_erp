 ...
 * @createtime:
 */
AdvanceRepayment = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				AdvanceRepayment.superclass.constructor.call(this, {
							id : 'advanceRepayment',
							title : '提前支取',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
					...
					items : [
						{
							...
							xtype : 'button',
							scope : this,
							hidden : isGranted('handleAdvanceRepaymentF') ? false : true,
							handler : function() {
								...
								if (s <= 0) {
									...
									var gpObj = new FinancingEarlyRepaymentView({
									...
									tabs.add(gpObj);
									tabs.setActiveTab("FinancingEarlyRepaymentView"+ record.data.projectId);
								}
							...
							xtype : 'button',
							scope : this,
							hidden : isGranted('_seePro_f1')?false:true,	
							handler : function() {
				...
				this.gridPanel=new HT.GridPanel({
					id : 'AdvanceRepaymentGrid',
					name : 'AdvanceRepaymentGridPanel',
					region : 'center',
					tbar : this.topbar,
					notmask :true,
					rowActions : false,
					...
					fields : [{
								name : 'runId',
								type : 'int'
							}, 'projectId', 'projectStatus','creator','orgName', 'projectName', 'projectNumber','customerName','startDate','endDate','projectMoney','payProjectMoney','oppositeTypeValue','customerName','projectStatus','operationType','operationTypeValue','taskId','activityName','oppositeId','oppositeType','businessType','businessManagerValue','payintentPeriod','payProjectMoney'],
					columns : [
							{
								header : 'projectId',
								dataIndex : 'projectId',
