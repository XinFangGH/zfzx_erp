...
public class FundIntentListPro3 {
...
//		gaomarker
		if(configMap.get("flowType").toString().equals("dltcCreditFlow")){
...
//					projectMoney.multiply(financeServiceOfRate).multiply(BigDecimal.valueOf(alldays)),
					projectMoney.multiply(financeServiceOfRate).multiply(BigDecimal.valueOf(payintentPeriod)),
					0,
					isPreposePayAccrual
					,payaccrualType,
					dayOfEveryPeriod,
