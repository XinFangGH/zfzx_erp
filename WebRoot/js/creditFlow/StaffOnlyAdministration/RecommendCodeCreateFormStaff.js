 ...
 * @company 智维软件
 */
RecommendCodeCreateFormStaff = Ext.extend(Ext.Window, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
        RecommendCodeCreateFormStaff.superclass.constructor.call(this, {
			id : 'RecommendCodeCreateFormStaff',
			layout : 'fit',
...
//		var mobile=this.mobile;
	...
	save : function() {
		...
		if(this.formPanel.getForm().isValid()){
			...
			var objectGridPanel=Ext.getCmp('staffOnlyAll').centerPanel;
