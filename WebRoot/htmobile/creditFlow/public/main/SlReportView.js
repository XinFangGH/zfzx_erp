...
//creditorList.js
Ext.define('htmobile.creditFlow.public.main.SlReportView', {
    extend: 'mobile.List',
	...
	if(typeof(_cfg.projectId)!="undefined") {
		...
		if(typeof(_cfg.businessType)!="undefined") {
			...
			if(this.businessType == 'SmallLoan' && this.Template=="ResearchReport"){
				...
				this.setname = '家访调查报告';
			}else if(this.businessType == 'SmallLoan' && this.Template=="CSJSBG"){
				this.ReportTemplate="CSJSBG"
				this.templettype = 11;
				this.titleText='初审件审报告';
				this.setname = '初审件审报告';
			}else if(this.businessType == 'SmallLoan' && this.Template=="WindControlReport"){
				this.ReportTemplate="WindControlReport"
				this.templettype = 11;
				this.titleText='风险分析报告';
				this.setname = '风险分析报告';
			}else if(this.businessType == 'SmallLoan' && this.Template=="DepositFormReport"){
				this.ReportTemplate="DepositFormReport"
				this.templettype = 11;
				this.titleText='放款单';
				this.setname = '放款单';
			}
    	...
    	Ext.apply(_cfg,{
    		...
    		fields:[{name : 'fileid'},{name : 'filename'}, {name : 'filepath'}, {name : 'extendname'}, {name : 'filesize'}, {name : 'createtime'}, {name : 'contentType'}, {name : 'webPath'},{name : 'projId'},{name : 'isArchiveConfirm'},{name : 'archiveConfirmRemark'}],
	    	    ...
	    	    params : {
						...
						mark :"cs_document_templet."+this.projId+"_"+ this.ReportTemplate,
