 ...
 * @company 智维软件
 */
DictionaryIndepForm = Ext.extend(Ext.Window, {
	// 内嵌FormPanel
	formPanel : null,
	// 构造函数
	constructor : function(_cfg) {
		...
		DictionaryIndepForm.superclass.constructor.call(this, {
			layout : 'fit',
	...
	initUIComponents : function() {
		this.formPanel = new Ext.FormPanel({
			url : __ctxPath + '/system/saveDictionaryIndependent.do',
			layout : 'form',
			id : 'DictionaryForm',
			...
			items : [ {
						...
						xtype:'hidden',
						id:'itemName',
						name:'dictionaryIndependent.itemName',
						value:this.typeName
					},{
						xtype:'hidden',
						id:'status',
						name:'dictionaryIndependent.status',
						value:'0'
					},
					{
						fieldLabel:'所属分类',
						...
						name : 'dictionaryIndependent.dicId',
						id : 'dicId',
						xtype : 'hidden',
					...
					{
						fieldLabel : '数值',
						name : 'dictionaryIndependent.itemValue',
						allowBlank : false,
						id : 'itemValue'
					},{
						fieldLabel : '序号',
						name:'dictionaryIndependent.sn',
						allowBlank : false,
						id : 'sn'
					},{
						fieldLabel : 'Key',
						name : 'dictionaryIndependent.dicKey',
						allowBlank : false,
						id : 'dicKey'
					}, {
						fieldLabel : '备注',
						name : 'dictionaryIndependent.descp',
						id : 'descp',
						xtype : 'textarea'
					}
		...
		if (this.dicId != null && this.dicId != 'undefined') {
			this.formPanel.getForm().load({
				...
				url : __ctxPath + '/system/getDictionaryIndependent.do?dicId='
						+ this.dicId,
				waitMsg : '正在载入数据...',
