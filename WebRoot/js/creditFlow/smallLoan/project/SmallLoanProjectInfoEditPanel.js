 ...
 * @extends Ext.Panel
 */
SmallLoanProjectInfoEditPanel = Ext.extend(Ext.Panel, {
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		this.initUIComponents();
		SmallLoanProjectInfoEditPanel.superclass.constructor.call(this, {
			id : 'SmallLoanProjectInfoEdit_' + this.record.data.projectId,// id属性值前缀,通过是否包含"Edit"来区分查看和编辑页面
	...
	initUIComponents : function() {
		var jsArr = [
				__ctxPath + '/js/creditFlow/smallLoan/project/SmallLoanProjectInfoEdit.js'// 项目信息
		];
	...
	constructPanel : function() {
		...
		// 项目信息
		this.projectInfo = new SmallLoanProjectInfoEdit({
			record : this.record
		});
