 ...
 */
public class OverDueDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.OverDueDataResponseDocument
{
    
    public OverDueDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName OVERDUEDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "overDueDataResponse");
    
    
    /**
     * Gets the "overDueDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.OverDueDataResponseDocument.OverDueDataResponse getOverDueDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.OverDueDataResponseDocument.OverDueDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.OverDueDataResponseDocument.OverDueDataResponse)get_store().find_element_user(OVERDUEDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOverDueDataResponse(nc.itf.crd.webservice.izyhtwebservice.OverDueDataResponseDocument.OverDueDataResponse overDueDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.OverDueDataResponseDocument.OverDueDataResponse)get_store().add_element_user(OVERDUEDATARESPONSE$0);
            }
            target.set(overDueDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.OverDueDataResponseDocument.OverDueDataResponse addNewOverDueDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class OverDueDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.OverDueDataResponseDocument.OverDueDataResponse
    {
        
        public OverDueDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
