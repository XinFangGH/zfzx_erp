 ...
 * @author 
 * @createtime 
 * @class SystemP2PSendSmsTemplateView
 * @extends Ext.Window
 * @description BpCouponSetting表单
 * @company 智维软件
 */
SystemP2PSendSmsTemplateView = Ext.extend(Ext.Window, {
	 isChange:false,
			//构造函数
			constructor : function(_cfg) {
				...
				SystemP2PSendSmsTemplateView.superclass.constructor.call(this, {
							id : 'SystemP2PSendSmsTemplateView',
							layout : 'fit',
			...
			send : function() {
				...
				if(telphone==null||telphone==""){
					...
					Ext.Ajax.request( {
						scope:this,
						url : __ctxPath + '/system/getSendInfoSystemProperties.do?telphone='+telphone+'&content='+this.content,
						method : 'post',
