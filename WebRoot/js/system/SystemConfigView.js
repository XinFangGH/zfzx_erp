 ...
 * @company 智维软件
 */
SystemConfigView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				SystemConfigView.superclass.constructor.call(this, {
							id : 'SystemConfigWin',
							layout : 'fit',
			...
			save : function() {
				...
				var insterest=this.getCmpByName('interestCbx').getValue();
				var defaultInterest=this.getCmpByName('defaultInterestCbx').getValue();
				$postForm({
