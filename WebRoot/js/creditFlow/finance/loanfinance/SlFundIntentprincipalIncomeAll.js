...
//						,{xtype:'label',html : '&nbsp;&nbsp已结清项】'}
				...
				this.gridPanel = new HT.GridPanel({
					...
					fields : [{
							...
							'businessType','projectId','tabType','orgName',
							'companyId','continueDates','faxiAfterMoney','payintentPeriod','amountPayable','continueInterest','continueDay','interestStarTime','interestEndTime','payintentPeriod','ids','bidPlanId'],
					columns : [{
								header : 'fundIntentId',
						...
						renderer : function(value, metaData, record, rowIndex,
							...
							, {
								...
								summaryType: 'sum',
								renderer:function(v){
								return Ext.util.Format.number(v==null?0:v,',000,000,000.00')+"元"
                         	     }
