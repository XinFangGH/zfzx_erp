...
public class VProjMortStockOwnerShip  implements java.io.Serializable {
    ...
    /** default constructor */
    public VProjMortStockOwnerShip() {
    }

	/** minimal constructor */
    public VProjMortStockOwnerShip(Integer id) {
        this.id = id;
    }
    
    /** full constructor */
    public VProjMortStockOwnerShip(Integer id, Integer mortgageid, String stockownership, 
    		...
    		Integer managementStatusId,Integer registerInfoId,Integer legalpersonid,String legalperson,java.util.Date registerdate,
    		String enterprisename,String hangyeTypeValue,String businessType,Integer hangyeType) {
        this.id = id;
