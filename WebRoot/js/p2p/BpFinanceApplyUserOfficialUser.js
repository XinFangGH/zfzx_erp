 ...
 * @createtime:
 */
BpFinanceApplyUserOfficialUser = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpFinanceApplyUserOfficialUser.superclass.constructor.call(this, {
							id : 'BpFinanceApplyUserOfficialUser',
							title : '已启动借款审批项目',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel=new HT.GridPanel({
					...
					url : __ctxPath + "/p2p/personListBpFinanceApplyUser.do?state=5",
					fields : [{
									name : 'loanId',
									type : 'int'
								}
