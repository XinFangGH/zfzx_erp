...
var dictionaryNotLastNodeTree=function(val,funName,extRootControl){//extControl add by gao  尽职调查页面 需求要求  只支持2 3 级双击返回值功能
	...
	var treeLoader = new Ext.tree.TreeLoader({
		...
		dataUrl :__ctxPath +'/creditFlow/multiLevelDic/getDictionaryNotLastNodeTreeWindowAreaDic.do',
