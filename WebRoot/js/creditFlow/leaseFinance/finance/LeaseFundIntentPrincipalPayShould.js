 ...
 * @createtime:
 */
LeaseFundIntentPrincipalPayShould = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				LeaseFundIntentPrincipalPayShould.superclass.constructor.call(this, {
							id : 'LeaseFundIntentPrincipalPayShould'+this.businessType+this.type,
