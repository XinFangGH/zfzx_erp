...
<title>模板管理</title>
	...
	<script type="text/javascript" src="<%=basePath%>js/creditManagement/optionManagement.js" charset="utf-8"></script>
	<script type="text/javascript" src="<%=basePath%>js/creditManagement/groupIndivator.js" charset="utf-8"></script>
	<script type="text/javascript" src="<%=basePath%>js/creditManagement/templateManagement.js" charset="utf-8"></script>
