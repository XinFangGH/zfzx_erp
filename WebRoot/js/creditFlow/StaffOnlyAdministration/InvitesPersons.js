 ...
 *
 */
InvitesPersons = Ext.extend(Ext.Panel, {
    // 构造函数
    constructor: function (_cfg) {
        ...
        // 调用父类构造
        InvitesPersons.superclass.constructor.call(this, {
            id: 'InvitesPersons',
            title: "推荐详情查询",
            region: 'center',
    ...
    initUIComponents: function () {
        ...
        this.gridPanel = new HT.GridPanel({
            ...
            //使用RowActions
            //rowActions:true,
            url: __ctxPath + "/p2p/searchInvitesBpCustMember.do",
            fields: [{
                name: 'userId',
                type: 'int'
            }
    ...
    export2Excel:function () {
        ...
        window.open( __ctxPath + "/p2p/searchInvitesBpCustMember.do?type=export&startDate="+startDate+"&endDate="+endDate+"&Q_loginname_S_LK="+name)
    },
