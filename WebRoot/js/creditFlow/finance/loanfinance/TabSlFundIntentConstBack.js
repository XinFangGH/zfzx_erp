 ...
 * @createtime:
 */
TabSlFundIntentConstBack= Ext.extend(Ext.Panel, {
			// 构造函数
			...
			constructor : function(_cfg) {
				...
				// 调用父类构造
				TabSlFundIntentConstBack.superclass.constructor.call(this, {
							id : 'TabSlFundIntentPrincipalPay',
							title : '费用退回台账',
			...
			initUIComponents : function() {
				var itemschange=[
				 	new SlFundIntentConstBackAll({tabflag:'ConstBackAll',businessType:this.businessType}),
				  	new SlFundIntentConstBackShould({tabflag:'ConstBackShould',businessType:this.businessType}),
					new SlFundIntentConstBackAlready({tabflag:'ConstBackAlready',businessType:this.businessType})
				];
