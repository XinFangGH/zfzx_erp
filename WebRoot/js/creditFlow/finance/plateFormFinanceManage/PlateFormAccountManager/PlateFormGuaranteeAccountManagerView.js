//PlateFormGuaranteeAccountManagerView.js
PlateFormGuaranteeAccountManagerView = Ext.extend(Ext.Panel, {
			title:"",
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				PlateFormGuaranteeAccountManagerView.superclass.constructor.call(this, {
							id : 'PlateFormGuaranteeAccountManagerView',
							title : "担保账户台账",
							region : 'center',
							layout : 'border',
							iconCls :'btn-team29',
