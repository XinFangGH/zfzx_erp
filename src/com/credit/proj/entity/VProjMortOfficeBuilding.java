...
public class VProjMortOfficeBuilding  implements java.io.Serializable {
     ...
     private Integer floors;//层高
     private Double buildacreage;//建筑面积(M2)
     private java.util.Date buildtime;//建成年份
     private Double residualyears;//剩余年份
     private Double mortgagesbalance;//按揭余额(万元)
     private Double rentone;//同等房产租金1(元/月/M2)
     private Double renttow;//同等房产租金2(元/月/M2)
     ...
     private Double leaseholdrangeprice;//租赁模型估值(万元)
    ...
    /** default constructor */
    public VProjMortOfficeBuilding() {
    }

	/** minimal constructor */
    public VProjMortOfficeBuilding(Integer id) {
        this.id = id;
    }
    
    /** full constructor */
    public VProjMortOfficeBuilding(Integer id, Integer mortgageid, String houseaddress, 
    		String certificatenumber, String propertyperson, String mutualofperson, 
    		Integer floors, Double buildacreage, java.util.Date buildtime, Double residualyears, 
    		Double mortgagesbalance, Double rentone, Double renttow, Double exchangepriceone, 
    		Double exchangepricetow, Double exchangepricethree, Double exchangefinalprice, 
    		Double leaseholdrangeprice, Double modelrangeprice, String propertyRightIdValue, 
    		String constructionTypeIdValue, String constructionFrameIdValue, String houseTypeIdValue, 
    		String descriptionIdValue, String registerInfoIdValue,Integer propertyRightId,
    		Integer constructionTypeId,Integer constructionFrameId,Integer houseTypeId,
