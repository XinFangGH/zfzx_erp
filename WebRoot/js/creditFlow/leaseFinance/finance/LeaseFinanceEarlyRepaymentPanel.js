...
LeaseFinanceEarlyRepaymentPanel = Ext.extend(Ext.Panel, {
	layout : "form",
	autoHeight : true,
	labelAlign : 'right',
	...
	constructor : function(_cfg) {
		...
		var rightlabel = 115;
	       ...
	       LeaseFinanceEarlyRepaymentPanel.superclass.constructor.call(this, {
			items : [{
				layout : "column",
				border : false,
				scope : this,
...
*/									}
  ...
  Ext.reg('LeaseFinanceEarlyRepaymentPanel', LeaseFinanceEarlyRepaymentPanel);
