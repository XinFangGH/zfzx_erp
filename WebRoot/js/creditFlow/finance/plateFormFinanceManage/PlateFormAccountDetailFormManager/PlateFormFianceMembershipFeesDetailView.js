...
PlateFormFianceMembershipFeesDetailView = Ext.extend(Ext.Panel, {
			title:"",
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				PlateFormFianceMembershipFeesDetailView.superclass.constructor.call(this, {
							id : 'PlateFormFianceMembershipFeesDetailView',
							title : "会员会费台账",
							region : 'center',
							layout : 'border',
							iconCls :'btn-team29',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					// 使用RowActions
					rowActions : false,
					id : 'PlateFormFianceMembershipFeesDetailGrid',
					//url : __ctxPath + "",
					fields : [{
								name : 'fundId',
								type : 'int'
