...
ReportMenuSmallloanprojectdetail = function(_cfg) {
		...
		if(typeof(_cfg.startDatel)!="undefined")
	{
		...
		if(typeof(_cfg.companyId)!="undefined")
	{
	      this.companyId=_cfg.companyId;
	}
	...
	return ReportPreviewSmallloanprojectdetail(this.reportId, this.title,this.reportKey,this.projectMoney,this.projectMoneyl,
