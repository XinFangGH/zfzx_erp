 ...
 * @createtime:
 */
CouponsBpfundIntentDetail = Ext.extend(Ext.Window, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				CouponsBpfundIntentDetail.superclass.constructor.call(this, {
							id : 'CouponsBpfundIntentDetail',
							layout : 'fit',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					isautoLoad:true,
					url : __ctxPath + "/creditFlow/finance/getCouponsFundInentDetailBpFundIntent.do?payintentPeriod="+this.payintentPeriod+"&fundType="+this.fundType+"&planId="+this.planId,
					fields : ['intentDate','factDate','payintentPeriod','investPersonName','incomeMoney','fundType'],
					columns : [ {
								header : '期数',
								align :'center',
