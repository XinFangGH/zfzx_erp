...
SlFundQlideView = Ext.extend(Ext.Window, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				SlFundQlideView.superclass.constructor.call(this, {
							id : 'SlFundQlideView',
							title : '上传资金流水',
							border : false,
							layout : 'fit',
			...
			this.formPanel = new Ext.FormPanel({
							...
							html:'<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="'+basepath()+'testupload.jsp?flag=qlideupload"> </iframe>'
