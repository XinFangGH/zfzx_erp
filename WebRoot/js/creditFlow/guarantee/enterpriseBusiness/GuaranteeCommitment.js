...
GuaranteeCommitment= Ext.extend(Ext.Panel, {
			...
			constructor : function(_cfg) {
				...
				// 调用父类构造
				GuaranteeCommitment.superclass.constructor.call(this, {
				...
				var jsArr = [__ctxPath + '/js/commonFlow/ExtUD.Ext.js',
				 __ctxPath+'/js/commonFlow/EnterpriseShareequity.js',
				  ...
				  __ctxPath+'/js/creditFlow/guarantee/enterpriseBusiness/enterpriseBusinessUI.js',
				   ...
				   __ctxPath+'/js/creditFlow/guarantee/enterpriseBusiness/guaranteeModel/GlExternalAssureRelieveCase.js'
			...
			constructPanel:function(){
				...
				this.glExternalAssureRelieveCase=new GlExternalAssureRelieveCase({projectId:this.projectId,businessType:6584})
				this.outPanel = new Ext.Panel({
							...
							items : [{
								...
								title : '对外担保承诺函',
								items : [this.glExternalAssureRelieveCase]
							}, {
								title : '意见与说明',
								layout : "form",
								items : [{
