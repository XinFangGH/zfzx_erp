...
ReportMenuFinancingprojectAnalysis = function(_cfg) {
	...
	return ReportPreviewFinancingprojectAnalysis(this.reportId, this.title,this.reportKey,this.projectMoney,this.projectMoneyl,
