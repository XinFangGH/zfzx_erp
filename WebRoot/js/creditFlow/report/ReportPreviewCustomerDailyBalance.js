var ReportPreviewCustomerDailyBalance = function(reportId, title,reportKey) {
			...
			pdfButton.on('click', function(xlsButton) {
				...
				if (formPanel.getForm().isValid()) {
					...
					formPanel.getForm().submit({
						waitMsg : '正在提交查询',
						url : __ctxPath + '/system/submitCustomerDailyBalanceReportTemplate.do?reportKey='+reportKey,
						method : 'post',
