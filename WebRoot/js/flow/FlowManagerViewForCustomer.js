 ...
 * 流程管理页
 */
 var FlowManagerViewForCustomer=function(){
 	return this.getView();
 };
 
 FlowManagerViewForCustomer.prototype.getView=function(){
 	    var selectedNode;
 		var proDefViewForCustomer=new ProDefinitionViewForCustomer(true);
			...
			split : true, 
	 		...
	 		//
			             ...
			             onclick:function(node){
			             	proDefViewForCustomer.setTypeId(node.id);
	...
	var panel = new Ext.Panel({
			...
			id:'FlowManagerViewForCustomer',
			height : 800,
			items : [treePanel,proDefViewForCustomer.getView()]
	});
