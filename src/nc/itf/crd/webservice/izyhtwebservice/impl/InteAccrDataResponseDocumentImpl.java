 ...
 */
public class InteAccrDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.InteAccrDataResponseDocument
{
    
    public InteAccrDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName INTEACCRDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "inteAccrDataResponse");
    
    
    /**
     * Gets the "inteAccrDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.InteAccrDataResponseDocument.InteAccrDataResponse getInteAccrDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.InteAccrDataResponseDocument.InteAccrDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.InteAccrDataResponseDocument.InteAccrDataResponse)get_store().find_element_user(INTEACCRDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setInteAccrDataResponse(nc.itf.crd.webservice.izyhtwebservice.InteAccrDataResponseDocument.InteAccrDataResponse inteAccrDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.InteAccrDataResponseDocument.InteAccrDataResponse)get_store().add_element_user(INTEACCRDATARESPONSE$0);
            }
            target.set(inteAccrDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.InteAccrDataResponseDocument.InteAccrDataResponse addNewInteAccrDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class InteAccrDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.InteAccrDataResponseDocument.InteAccrDataResponse
    {
        
        public InteAccrDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
