 ...
 */
public class CancelDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.CancelDataResponseDocument
{
    
    public CancelDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CANCELDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "cancelDataResponse");
    
    
    /**
     * Gets the "cancelDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.CancelDataResponseDocument.CancelDataResponse getCancelDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.CancelDataResponseDocument.CancelDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.CancelDataResponseDocument.CancelDataResponse)get_store().find_element_user(CANCELDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCancelDataResponse(nc.itf.crd.webservice.izyhtwebservice.CancelDataResponseDocument.CancelDataResponse cancelDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.CancelDataResponseDocument.CancelDataResponse)get_store().add_element_user(CANCELDATARESPONSE$0);
            }
            target.set(cancelDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.CancelDataResponseDocument.CancelDataResponse addNewCancelDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class CancelDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.CancelDataResponseDocument.CancelDataResponse
    {
        
        public CancelDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
