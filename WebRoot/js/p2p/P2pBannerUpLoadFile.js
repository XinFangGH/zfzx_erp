 ...
 * @company 智维软件
 */
P2pBannerUpLoadFile = Ext.extend(Ext.Window, {
	// 构造函数
...
//		Ext.applyIf(this, _cfg);
		...
		P2pBannerUpLoadFile.superclass.constructor.call(this, {
					id : 'P2pBannerUpLoad',
					layout : 'fit',
...
//		}
	...
	save : function() {
		...
		$postForm({
					...
					scope : this,
					url : __ctxPath
							+ '/p2p/upLoadFilesP2pBannerlink.do',
...
////				 }
					callback : function(fp, action) {
						...
						var path=object.webPath;
						 if(targetForm!=null){
						 	var  record =targetForm.getCmpByName("p2pBannerlink.url");
...
//						var flag =object.webPath;//flag用来判断是否本金款项是否已经对账：0表示没有对账，1表示已经对账
						...
						var gridPanel = Ext.getCmp('p2pBannerlink.url');
						if (gridPanel != null) {
							gridPanel.setValue();
						}
						this.close();
