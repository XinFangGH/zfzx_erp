...
public class Fuiou{
	 ...
	 * 16富有金账户余额查询url
	 */
	public static final String FUIOUCURRENTMONEY="/jzh/BalanceAction.action";
	 ...
	 * 18富有预授权url
	 */
	public static final String FUIOUPREAUTO="/jzh/preAuth.action";
	/**
	 * 19富有预授权撤销url
	 */
	public static final String FUIOUPREAUTOCANC="/jzh/preAuthCancel.action";
	
	/**
	 * 20富有转账（商户和用户之间互转）url
	 */
	public static final String FUIOUTRAACC="/jzh/transferBmu.action";
	
	/**
	 * 21富有转账（个人和个人）url
	 * svn:songwj
	 */
	public static final String FUIOUTRANSFERPERSONTOPERSON="/jzh/transferBu.action";
	/**
	 ...
	 * 27富有转账查询接口URL
	 */
	public static final String FUIOUTRANSFERQUERY="/jzh/queryTxn.action";
	
	/**
	 * 28富有充值取现查询接口URL
	 */
	public static final String FUIOURECHWITHDQUERY="/jzh/querycztx.action";
	/**
	 * 资金明细查询
	 */
	public static final  String FUIOUTRADEDETAIL="/jzh/ queryTxn.action";
