 ...
 * @extends Ext.Panel
 */
flPostponedProjectInfoEditPanel = Ext.extend(Ext.Panel, {
	constructor : function(_cfg) {
		...
		flPostponedProjectInfoEditPanel.superclass.constructor.call(this, {
	...
	constructPanel : function() {
		...
		// 项目信息
		this.postponedProjectInfo = new flPostponedProjectInfoEdit({
			record : this.record,
