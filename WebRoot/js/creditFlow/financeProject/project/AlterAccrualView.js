 ...
 * @createtime:
 */
AlterAccrualView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				AlterAccrualView.superclass.constructor.call(this, {
							id : 'AlterAccrualView',
							title : '提前支取',
							region : 'center',
							layout : 'border',
					...
					items : [
						{
							...
							xtype : 'button',
							scope : this,
							hidden : isGranted('handleAlterAccrualViewF') ? false : true,
							handler : function() {
								...
								if (s <= 0) {
									...
									var gpObj = new FinancingAlterAccrualView({
									...
									tabs.add(gpObj);
									tabs.setActiveTab("FinancingAlterAccrualView"+ record.data.projectId);
								}
