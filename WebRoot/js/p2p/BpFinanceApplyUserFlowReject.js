 ...
 * @createtime:
 */
BpFinanceApplyUserFlowReject = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpFinanceApplyUserFlowReject.superclass.constructor.call(this, {
							id : 'BpFinanceApplyUserFlowReject',
							title : '审批流程被驳回',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel=new HT.GridPanel({
					...
					url : __ctxPath + "/p2p/personListBpFinanceApplyUser.do?state=6",
					fields : [{
									name : 'loanId',
									type : 'int'
								}
