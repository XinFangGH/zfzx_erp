...
var update_button_r = new Ext.Button({
						...
						handler : function() {
							...
							if (gselectid == '0') {
								Ext.ux.Toast.msg('操作提示', '请选择您要修改的担保材料项！');
								return;
							}
							Ext.Ajax.request({
								url : __ctxPath+ '/materials/getOurProcreditMaterialsEnterprise.do',
																			...
																			.request(
																					{
																						...
																						success : function(response,request)
																					    {
																							...
																							if (objs.data == null) {
																								...
																								Ext.ux.Toast.msg('操作提示','请办输入正确的担保材料ID号!');
																								return;
																							} else {
