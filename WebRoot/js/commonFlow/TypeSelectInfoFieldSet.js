...
ExtUD.Ext.TypeSelectInfoFieldSet = Ext.extend(Ext.form.FieldSet, {
	columnWidth : .8,
	title : '选择信息',
	collapsible : true,
	autoHeight : true,
	...
	constructor : function(_cfg) {
		...
		ExtUD.Ext.TypeSelectInfoFieldSet.superclass.constructor.call(this, {
			items : [{}, {}, {}]
		});
	}
})
ExtUD.Ext.PeerMainInfoFieldSet = Ext.extend(Ext.form.FieldSet, {
	...
	constructor : function(_cfg) {
		...
		Ext.applyIf(this, _cfg);
		ExtUD.Ext.PeerMainInfoFieldSet.superclass.constructor.call(this, {
			items : [{
				xtype : "panel",
				border : false,
				layout : "column",
...
Ext.reg('typeSelectInfoFieldSet', ExtUD.Ext.TypeSelectInfoFieldSet);// 第一个参数为自定义控件的xtype
Ext.reg('peerMainInfoFieldSet', ExtUD.Ext.PeerMainInfoFieldSet);// 第一个参数为自定义控件的xtype
