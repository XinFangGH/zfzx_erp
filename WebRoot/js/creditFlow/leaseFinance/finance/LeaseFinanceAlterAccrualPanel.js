...
LeaseFinanceAlterAccrualPanel = Ext.extend(Ext.Panel, {
	layout : "form",
	autoHeight : true,
	labelAlign : 'right',
	...
	constructor : function(_cfg) {
		...
		var rightlabel = 115;
			...
			LeaseFinanceAlterAccrualPanel.superclass.constructor.call(this, {
			items : [{
				layout : "column",
				border : false,
				scope : this,
				...
				items : [{
					...
					name : 'slAlterAccrualRecord.oriaccrual'
				},{
				...
				columnWidth : 1,
					...
					items : [{
						...
						value : slAlterAccrualRecorddata==null?null:slAlterAccrualRecorddata.payaccrualType
					...
					items : [{
								...
								allowBlank : false,
								readOnly : this.isAllReadOnly,
								value : slAlterAccrualRecorddata==null?null:slAlterAccrualRecorddata.payintentPeriod,
					...
					items : [ {
							...
							items : [{
										...
										value : slAlterAccrualRecorddata==null?null:slAlterAccrualRecorddata.payintentPerioDate,
										xtype : 'combo',
										mode : 'local',
										displayField : 'name',
										valueField : 'id',
				...
				//			hideLabel :true,
							...
							items : [{
								xtype : "hidden",
								name : "slAlterAccrualRecord.isPreposePayAccrual",
								boxLabel : "是否前置付息",
								value : 0
							}]
						}]
				*/}/*, {
							...
							items : [{
								...
								value : slAlterAccrualRecorddata==null?null:slAlterAccrualRecorddata.managementConsultingOfRate,
								allowBlank : false,
								fieldLabel : "管理咨询费率",
								decimalPrecision : 10,
								fieldClass : 'field-align',
							...
							items : [{
								...
								value : slAlterAccrualRecorddata==null?null:slAlterAccrualRecorddata.accrualtype,
  ...
  Ext.reg('LeaseFinanceAlterAccrualPanel', LeaseFinanceAlterAccrualPanel);
