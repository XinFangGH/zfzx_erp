 ...
 * @createtime:
 */
MatchFundsFailView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		MatchFundsFailView.superclass.constructor.call(this, {
					id : 'MatchFundsFailView' + this.tabflag,
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			url : onclickflag == 0
					? __ctxPath + '/project/findListSlSmallloanProject.do?projectStatus=3&isGrantedShowAllProjects='+this.isGrantedShowAllProjects
					: null,
			fields : [{
						name : 'projectId',
						type : 'int'
