...
/**
 * VProcreditDictionaryGuarantee entity. @author MyEclipse Persistence Tools
 */

public class VProcreditDictionaryGuarantee extends BaseVProcreditDictionaryExceptFinancing implements java.io.Serializable {
	...
	@Expose
	private Boolean isHandle;//是否办理 add by gaoqingrui
	@Expose
	...
	private Long days;  //距离银行放款的天数
	private String mortgageStatus;//抵质押物的状态
//	private java.util.Date loanDate;//银行放款时间
	...
	public VProcreditDictionaryGuarantee() {
		super();
	}

	
	
	public VProcreditDictionaryGuarantee(String assuremodeidValue,
			...
			String enregisterDepartment,Integer fileCounts,String mortgageStatus,Long days,java.util.Date loanDate,
			String transactPerson,String unchainPerson,String transactRemarks,Integer dywId,String mortgageRemarks,String companyName) {
