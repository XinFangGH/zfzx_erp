var seeBusinessAndLive = function(pawnItemId,typeid){
			...
			items : [{
	            ...
	            items : [{
					...
					items : [{
						...
						items : [{
							html : '<b>地段描述：</b> ' + function(){if(typeof(MortgageData.vProjMortBusAndLive.descriptionIdValue)!="undefined"){return MortgageData.vProjMortBusAndLive.descriptionIdValue}else{return ''}}()
						},{
							html : '<b>登记情况：</b>' + function(){if(typeof(MortgageData.vProjMortBusAndLive.registerInfoIdValue)!="undefined"){return MortgageData.vProjMortBusAndLive.registerInfoIdValue}else{return ''}}()
						},{
