 ...
 */
public class IntePlanDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.IntePlanDataResponseDocument
{
    
    public IntePlanDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName INTEPLANDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "intePlanDataResponse");
    
    
    /**
     * Gets the "intePlanDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.IntePlanDataResponseDocument.IntePlanDataResponse getIntePlanDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.IntePlanDataResponseDocument.IntePlanDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.IntePlanDataResponseDocument.IntePlanDataResponse)get_store().find_element_user(INTEPLANDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setIntePlanDataResponse(nc.itf.crd.webservice.izyhtwebservice.IntePlanDataResponseDocument.IntePlanDataResponse intePlanDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.IntePlanDataResponseDocument.IntePlanDataResponse)get_store().add_element_user(INTEPLANDATARESPONSE$0);
            }
            target.set(intePlanDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.IntePlanDataResponseDocument.IntePlanDataResponse addNewIntePlanDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class IntePlanDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.IntePlanDataResponseDocument.IntePlanDataResponse
    {
        
        public IntePlanDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
