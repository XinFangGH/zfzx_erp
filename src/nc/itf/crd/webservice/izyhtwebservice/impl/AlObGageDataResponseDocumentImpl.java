 ...
 */
public class AlObGageDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.AlObGageDataResponseDocument
{
    
    public AlObGageDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ALOBGAGEDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "alObGageDataResponse");
    
    
    /**
     * Gets the "alObGageDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.AlObGageDataResponseDocument.AlObGageDataResponse getAlObGageDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.AlObGageDataResponseDocument.AlObGageDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.AlObGageDataResponseDocument.AlObGageDataResponse)get_store().find_element_user(ALOBGAGEDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAlObGageDataResponse(nc.itf.crd.webservice.izyhtwebservice.AlObGageDataResponseDocument.AlObGageDataResponse alObGageDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.AlObGageDataResponseDocument.AlObGageDataResponse)get_store().add_element_user(ALOBGAGEDATARESPONSE$0);
            }
            target.set(alObGageDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.AlObGageDataResponseDocument.AlObGageDataResponse addNewAlObGageDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class AlObGageDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.AlObGageDataResponseDocument.AlObGageDataResponse
    {
        
        public AlObGageDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
