 ...
 * @createtime:
 */
BpComApplyUserRejected = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpComApplyUserRejected.superclass.constructor.call(this, {
							id : 'BpComApplyUserRejected',
							title : '已拒绝',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					url : __ctxPath + "/p2p/listBpFinanceApply.do?ck=1&state=2",
					fields : [{
								name : 'loanId',
								type : 'int'
