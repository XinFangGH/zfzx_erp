 ...
 * @createtime:
 */
BpFinanceApplyUserNotSubmitView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpFinanceApplyUserNotSubmitView.superclass.constructor.call(this, {
							id : 'BpFinanceApplyUserNotSubmitView',
							title : '未提交',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel=new HT.GridPanel({
					...
					url : __ctxPath + "/p2p/personListBpFinanceApplyUser.do?state=0",
					fields : [{
									name : 'loanId',
									type : 'int'
								}
