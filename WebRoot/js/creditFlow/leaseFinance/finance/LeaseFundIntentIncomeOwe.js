 ...
 * @createtime:
 */
LeaseFundIntentIncomeOwe = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				LeaseFundIntentIncomeOwe.superclass.constructor.call(this, {
							id : 'LeaseFundIntentIncomeOwe'+this.businessType+this.type,
							title : '欠收款项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team29',
...
//						,{xtype:'label',html : '&nbsp;&nbsp已结清项】'}
				...
				this.gridPanel = new HT.GridPanel({
					...
					fields : [{
							...
							'isInitialorId','orgName','companyId','interestStarTime','interestEndTime'],
					columns : [{
								header : 'fundIntentId',
