 ...
 * @createtime:
 */
LeaseFundIntentIncomeShould = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				LeaseFundIntentIncomeShould.superclass.constructor.call(this, {
							id : 'LeaseFundIntentIncomeShould'+this.businessType+this.type,
							title : '应收款项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team29',
...
//						,{xtype:'label',html : '&nbsp;&nbsp已结清项】'}
				...
				this.gridPanel = new HT.GridPanel({
					...
					fields : [{
							...
							'companyId','interestStarTime','interestEndTime'],
					columns : [{
								header : 'fundIntentId',
