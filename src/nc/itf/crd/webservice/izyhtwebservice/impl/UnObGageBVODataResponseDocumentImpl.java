 ...
 */
public class UnObGageBVODataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.UnObGageBVODataResponseDocument
{
    
    public UnObGageBVODataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName UNOBGAGEBVODATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "unObGageBVODataResponse");
    
    
    /**
     * Gets the "unObGageBVODataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.UnObGageBVODataResponseDocument.UnObGageBVODataResponse getUnObGageBVODataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.UnObGageBVODataResponseDocument.UnObGageBVODataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.UnObGageBVODataResponseDocument.UnObGageBVODataResponse)get_store().find_element_user(UNOBGAGEBVODATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setUnObGageBVODataResponse(nc.itf.crd.webservice.izyhtwebservice.UnObGageBVODataResponseDocument.UnObGageBVODataResponse unObGageBVODataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.UnObGageBVODataResponseDocument.UnObGageBVODataResponse)get_store().add_element_user(UNOBGAGEBVODATARESPONSE$0);
            }
            target.set(unObGageBVODataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.UnObGageBVODataResponseDocument.UnObGageBVODataResponse addNewUnObGageBVODataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class UnObGageBVODataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.UnObGageBVODataResponseDocument.UnObGageBVODataResponse
    {
        
        public UnObGageBVODataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
