 ...
 * @createtime:
 */
LeaseFundIntentPrincipalPayAlready = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				LeaseFundIntentPrincipalPayAlready.superclass.constructor.call(this, {
							id : 'LeaseFundIntentPrincipalPayAlready'+this.businessType,
