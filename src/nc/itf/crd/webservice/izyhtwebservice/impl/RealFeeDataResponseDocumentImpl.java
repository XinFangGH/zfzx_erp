 ...
 */
public class RealFeeDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.RealFeeDataResponseDocument
{
    
    public RealFeeDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName REALFEEDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "realFeeDataResponse");
    
    
    /**
     * Gets the "realFeeDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.RealFeeDataResponseDocument.RealFeeDataResponse getRealFeeDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.RealFeeDataResponseDocument.RealFeeDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.RealFeeDataResponseDocument.RealFeeDataResponse)get_store().find_element_user(REALFEEDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRealFeeDataResponse(nc.itf.crd.webservice.izyhtwebservice.RealFeeDataResponseDocument.RealFeeDataResponse realFeeDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.RealFeeDataResponseDocument.RealFeeDataResponse)get_store().add_element_user(REALFEEDATARESPONSE$0);
            }
            target.set(realFeeDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.RealFeeDataResponseDocument.RealFeeDataResponse addNewRealFeeDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class RealFeeDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.RealFeeDataResponseDocument.RealFeeDataResponse
    {
        
        public RealFeeDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
