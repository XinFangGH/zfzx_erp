 ...
 * @company 智维软件
 */
SlEarlyrepaymentRecordEditInfo = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		SlEarlyrepaymentRecordEditInfo.superclass.constructor.call(this, {
			autoScroll:true,
	...
	save : function(){
		if(typeof(this.formPanel.getCmpByName('EarlyRepaymentSlFundIntentPanel'))!='undefined' && null!=this.formPanel.getCmpByName('EarlyRepaymentSlFundIntentPanel')){
			 var fundIntentJsonData=this.formPanel.getCmpByName('EarlyRepaymentSlFundIntentPanel').getGridDate();
			this.formPanel.getCmpByName('earlyFundIntentJsonData').setValue(fundIntentJsonData);
		}
		this.formPanel.getForm().submit({
			...
			success : function(fp, action) {
				...
				if(typeof(this.formPanel.getCmpByName('EarlyRepaymentSlFundIntentPanel'))!='undefined' && null!=this.formPanel.getCmpByName('EarlyRepaymentSlFundIntentPanel')){
		       		this. formPanel.getCmpByName('EarlyRepaymentSlFundIntentPanel').save();
				}
