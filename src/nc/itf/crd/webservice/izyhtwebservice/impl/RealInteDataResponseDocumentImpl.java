 ...
 */
public class RealInteDataResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.RealInteDataResponseDocument
{
    
    public RealInteDataResponseDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName REALINTEDATARESPONSE$0 = 
        new javax.xml.namespace.QName("http://webservice.crd.itf.nc/IZyhtWebService", "realInteDataResponse");
    
    
    /**
     * Gets the "realInteDataResponse" element
     */
    public nc.itf.crd.webservice.izyhtwebservice.RealInteDataResponseDocument.RealInteDataResponse getRealInteDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            nc.itf.crd.webservice.izyhtwebservice.RealInteDataResponseDocument.RealInteDataResponse target = null;
            target = (nc.itf.crd.webservice.izyhtwebservice.RealInteDataResponseDocument.RealInteDataResponse)get_store().find_element_user(REALINTEDATARESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRealInteDataResponse(nc.itf.crd.webservice.izyhtwebservice.RealInteDataResponseDocument.RealInteDataResponse realInteDataResponse)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (nc.itf.crd.webservice.izyhtwebservice.RealInteDataResponseDocument.RealInteDataResponse)get_store().add_element_user(REALINTEDATARESPONSE$0);
            }
            target.set(realInteDataResponse);
        }
    }
     ...
     */
    public nc.itf.crd.webservice.izyhtwebservice.RealInteDataResponseDocument.RealInteDataResponse addNewRealInteDataResponse()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class RealInteDataResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements nc.itf.crd.webservice.izyhtwebservice.RealInteDataResponseDocument.RealInteDataResponse
    {
        
        public RealInteDataResponseImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
