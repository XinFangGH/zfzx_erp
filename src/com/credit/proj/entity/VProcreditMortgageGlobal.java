...
public class VProcreditMortgageGlobal extends BaseVProcreditDictionaryExceptFinancing implements java.io.Serializable {
/*
 * add by gao  不在以businessType区分
 * */
	...
	public VProcreditMortgageGlobal() {
		super();
	}
	...
	public VProcreditMortgageGlobal(String assuremodeidValue,
			...
			BigDecimal finalCertificationPrice,String valuationMechanism,Date valuationTime) {
		super();
