...
ReportMenuFinancingprojectdetail = function(_cfg) {
	...
	return ReportPreviewFinancingprojectdetail(this.reportId, this.title,this.reportKey,this.projectMoney,this.projectMoneyl,
