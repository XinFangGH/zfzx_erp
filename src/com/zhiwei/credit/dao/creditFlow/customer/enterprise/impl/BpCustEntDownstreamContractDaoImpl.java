...
public class BpCustEntDownstreamContractDaoImpl extends BaseDaoImpl<BpCustEntDownstreamContract> implements BpCustEntDownstreamContractDao{

	public BpCustEntDownstreamContractDaoImpl() {
		super(BpCustEntDownstreamContract.class);
	}
