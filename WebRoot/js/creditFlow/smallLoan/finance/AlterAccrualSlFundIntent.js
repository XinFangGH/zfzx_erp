...
AlterAccrualSlFundIntent = Ext.extend(Ext.Panel,
				{ 
...
//					  this.businessType="Financing";
						...
						AlterAccrualSlFundIntent.superclass.constructor
								.call(this, {
									layout:'anchor',
		  					        anchor : '100%',
									items : [
...
//								xtype : 'datecolumn',
				...
				autocreate : function() { 
					 ...
					 var calcutype="SmallLoan";
					 var accrual=null;
				    var alelrtDate=null;
				    var slAlteraccrualRecordId=null;
					 if(this.businessType=="SmallLoan"){
					  slAlteraccrualRecordId=this.object.getCmpByName("slAlterAccrualRecord.slAlteraccrualRecordId").getValue();
			 ...
			 if(message !=""){   
					...
					var params1={
						...
						'slAlterAccrualRecord.slAlteraccrualRecordId': slAlteraccrualRecordId,
						...
						var st="";
							for ( var i = 0; i < vCount; i++) {
								...
								if(vRecords[i].data.fundType !=null && vRecords[i].data.fundType !=""){
									 if(vRecords[i].data.afterMoney==null || vRecords[i].data.afterMoney == 0)  {
											  st={"fundType":vRecords[i].data.fundType,
											  ...
											  'payintentPeriod':vRecords[i].data.payintentPeriod==''?0:vRecords[i].data.payintentPeriod,
											  "interestStarTime":vRecords[i].data.interestStarTime,
											  "interestEndTime":vRecords[i].data.interestEndTime,
											  "preceptId":this.preceptId,
											  "slAlteraccrualRecordId":this.isThisAlterAccrualRecordId};
