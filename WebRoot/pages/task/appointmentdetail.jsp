...
<%@page import="com.zhiwei.credit.service.task.AppointmentService"%>
<%@page import="com.zhiwei.credit.service.task.impl.AppointmentServiceImpl"%>
<%@page import="com.zhiwei.core.web.paging.PagingBean"%>
<%@page import="com.zhiwei.credit.model.task.Appointment"%>
<%
	Long appointId = null;
...
<%@page import="com.zhiwei.core.command.QueryFilter"%><table class="table-info" width="98%" cellpadding="0" cellspacing="1">
	<tr>
		<td width="20%">主题：</td>
		<td width="80%">
			${appointment.subject}
