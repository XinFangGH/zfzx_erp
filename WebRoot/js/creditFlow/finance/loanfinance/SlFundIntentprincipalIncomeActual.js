...
//						,{xtype:'label',html : '&nbsp;&nbsp已结清项】'}
				...
				this.gridPanel = new HT.GridPanel({
					...
					fields : [{
							...
							'overdueRate', 'accrualMoney','faxiAfterMoney', 'status','remark','businessType','projectId','orgName','companyId','interestStarTime','interestEndTime','payintentPeriod','ids','bidPlanId'],
					columns : [{
								header : 'fundIntentId',
