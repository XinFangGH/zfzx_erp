...
ArchiveConfirm = Ext.extend(Ext.Panel, {
	formPanel : null,
	projectId : '$!projectId',
	...
	constructor : function(_cfg) {
		...
		this.initComponents();
		ArchiveConfirm.superclass.constructor.call(this, {
			...
			__ctxPath + '/js/creditFlow/guarantee/enterpriseBusiness/enterpriseBusinessUI.js',//项目基本信息
			 __ctxPath + '/js/commonFlow/ExtUD.Ext.js',
			  __ctxPath+'/js/commonFlow/EnterpriseShareequity.js',
			   ...
			   __ctxPath+'/js/creditFlow/guarantee/enterpriseBusiness/guaranteeModel/ArchiveFile.js'
