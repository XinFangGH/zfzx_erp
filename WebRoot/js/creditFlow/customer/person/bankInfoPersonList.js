function bankInfoListPersonWin(customerId,isReadOnly,isInvest){
	var pageSize = 10 ;
	var anchor = '100%';
			...
			var button_add_debt = new CS.button.AButton({
				handler : function() {
					...
					var win_add_company = new Ext.Window({
						id : 'win_addBankInfo',
						title: '新增<font color=red><'+obj.data.shortname+'></font>开户银行信息',
						layout : 'fit',
					...
					if (null == selected) {
						...
						Ext.Ajax.request({
							...
							success : function(response,request) {
								...
								var fPanel_updateBankInfo = new CS.form.FormPanel({
									url:__ctxPath + '/credit/customer/enterprise/updateEnterpriseBank.do',
									bodyStyle : 'padding:10px;',
									width : 488,
									height : 278,
									labelWidth : 90,
						...
						//			submitValue:false,
								...
								var window_update = new Ext.Window({
									...
									title: '编辑<font color=red><'+obj.data.shortname+'></font>开户银行信息',
									layout : 'fit',
									width :(screen.width-180)*0.55,
									height : 310,
									closable : true,
