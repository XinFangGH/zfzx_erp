 ...
 * @company 智维软件
 */
FinanceBaozMortgageListView = Ext.extend(Ext.Window, {
	// 构造函数
	constructor : function(_cfg) {
		...
		FinanceBaozMortgageListView.superclass.constructor.call(this, {
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			// 使用RowActions
			url : __ctxPath
					+ '/credit/mortgage/getMortgageFinanceList.do?isPledged=0&type=BZ',
			fields : [{
						name : 'id',
						type : 'int'
	...
	*/},
	...
	createRs : function() {
		...
		new AddBaozMortgageWin({projectId:0,businessType:this.businessType,gridPanel:this.gridPanel}).show()
