AppHomeTeamCreditAssignment = Ext.extend(Ext.Panel, { 
	...
	constructor : function(_cfg) {
		...
		AppHomeTeamCreditAssignment.superclass.constructor.call(this, {
			title : '债权转让桌面',
			closable : false,
			id : 'AppHomeTeamCreditAssignment',
			border : false,
			autoScroll : true,
			...
			items : [{
				...
				items : [{
					...
					items : [{
								xtype : 'button',
								text : '客户登记',
								disabled : isGranted('_create_qykh')==true||isGranted('_create_grkh')==true
										? false
										: true,
								iconCls : 'btn-team21',
								anchor : '100%',
				...
				items : [{
					...
					items : [{
						...
						bodyStyle : 'margin-left:0px;margin-top:5px',
						width : 120,
						html : '<B><font class="x-myZW-fieldset-title">【投资客户管理】：</font></B>'
					}]
				}, {
					layout : "form", // 从上往下的布局
					items : [{
								xtype : 'button',
								text : '投资客户信息管理',
								//disabled : isGranted('_invester_khxx')==true ? false: true,
								iconCls : 'btn-tree-invest63-desktop',
								anchor : '100%',
								height : btnheigth,
								scope : this,
								handler : function() {
									App.clickTopTab('investmentPersonView',{
					...
					items : [{
								...
								height : btnheigth,
								text : '投资人账户管理',
								//disabled : isGranted('_invester_zhgl')? false: true,
								iconCls : 'btn-tree-invest64-desktop',
								scope : this,
								handler : function() {
									App.clickTopTab('investmentAccountView',{
										businessType : 'SmallLoan',
										accountType:"account"
									});
								}
					...
					items : [{
								...
								height : btnheigth,
								text : '投资账户收支查询',
								//disabled : isGranted('investmentAccountView')? false: true,
								iconCls : 'btn-tree-invest65-desktop',
								scope : this,
								handler : function() {
									App.clickTopTab('investmentAccountView',{
										businessType : 'SmallLoan',
					...
					items : [{
						...
						text : '投资人债权查询',
						//disabled : isGranted('investmentAccountView')? false: true,
						iconCls : 'btn-tree-invest66-desktop',
						scope : this,
						handler : function() {
							App.clickTopTab('investmentAccountView',{
										businessType : 'SmallLoan',
					...
					items : [{
						...
						height : btnheigth,
						text : '取现审核清单',
						//disabled : isGranted('investmentEnchashmentListView')? false: true,
						iconCls : 'btn-tree-invest67-desktop',
						scope : this,
						handler : function() {
							App.clickTopTab('investmentEnchashmentListView', {
										businessType : 'SmallLoan'
							});
						}
					}]
				...
				items : [{
					...
					items : [{
						...
						bodyStyle : 'margin-left:0px;margin-top:5px',
						width : 120,
						html : '<B><font class="x-myZW-fieldset-title">【投资理财管理】：</font></B>'
					}]
				}, {
					layout : "form", // 从上往下的布局
					items : [{
								...
								text : '为投资人匹配债权',
								//disabled : isGranted('_invester_khxx')==true ? false: true,
								iconCls : 'btn-tree-invest69-desktop',
								anchor : '100%',
								height : btnheigth,
								scope : this,
								handler : function() {
									App.clickTopTab('mappingObligationToInvestView');
								}
							}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
								...
								text : '债权到期提醒',
								//disabled : isGranted('_invester_zhgl')? false: true,
								iconCls : 'btn-tree-invest70-desktop',
								scope : this,
								handler : function() {
									App.clickTopTab('investmentObligationRemindView');
								}
							}]
				}]
			},/*{
				...
				items : [{
					...
					items : [{
						...
						bodyStyle : 'margin-left:0px;margin-top:5px',
						width : 120,
						html : '<B><font class="x-myZW-fieldset-title">【债权产品管理】：</font></B>'
					}]
				}, {
					layout : "form", // 从上往下的布局
					items : [{
								...
								text : '债权产品信息管理',
								//disabled : isGranted('_invester_khxx')==true ? false: true,
								iconCls : 'btn-tree-obliga72-desktop',
								anchor : '100%',
								height : btnheigth,
								scope : this,
								handler : function() {
									App.clickTopTab('obligationproductInfoView',{
										managerType:'Info'
									});
								}
							}]
					...
					items : [{
								...
								text : '债权产品匹配管理',
								//disabled : isGranted('_invester_zhgl')? false: true,
								iconCls : 'btn-tree-obliga73-desktop',
								scope : this,
								handler : function() {
									App.clickTopTab('obligationproductInfoView',{
										managerType:'Mapping'
					...
					items : [{
								...
								text : '债权产品开关管理',
								//disabled : isGranted('investmentAccountView')? false: true,
								iconCls : 'btn-tree-obliga74-desktop',
								scope : this,
								handler : function() {
									App.clickTopTab('obligationProductTab',{
										openType:'switchManager'
									});
								}
							}]
				}, {
					...
					items : [{
						...
						text : '债权产品资金动态',
						//disabled : isGranted('investmentAccountView')? false: true,
						iconCls : 'btn-tree-obliga75-desktop',
						scope : this,
						handler : function() {
							App.clickTopTab('obligationproductFundDynamicView');
						}
					}]
				}]
			},*/{
				...
				items : [{
					...
					items : [{
						...
						bodyStyle : 'margin-left:0px;margin-top:5px',
						width : 120,
						html : '<B><font class="x-myZW-fieldset-title">【债权库查询】：</font></B>'
					}]
				}, {
					layout : "form", // 从上往下的布局
					items : [{
								...
								text : '债权匹配情况',
								//disabled : isGranted('_invester_khxx')==true ? false: true,
								iconCls : 'btn-tree-obliga77-desktop',
								anchor : '100%',
								height : btnheigth,
								scope : this,
								handler : function() {
									App.clickTopTab('obligationMappingInfoView',{
										obligationState:'0'
									});
								}
							}]
				...
				items : [{
					...
					items : [{
						...
						bodyStyle : 'margin-left:0px;margin-top:5px',
						width : 120,
						html : '<B><font class="x-myZW-fieldset-title">【充值审核管理】：</font></B>'
					}]
				}, {
					layout : "form", // 从上往下的布局
					items : [{
								...
								text : '充值确认',
								//disabled : isGranted('_invester_khxx')==true ? false: true,
								iconCls : 'btn-tree-recharge79-desktop',
								anchor : '100%',
								height : btnheigth,
								scope : this,
								handler : function() {
									App.clickTopTab('confirmRechargeView',{
									rechargeLevel:'1'
									});
								}
							}]
					...
					items : [{
								...
								text : '充值高级确认',
								//disabled : isGranted('_invester_zhgl')? false: true,
								iconCls : 'btn-tree-recharge80-desktop',
								scope : this,
								handler : function() {
									App.clickTopTab('confirmRechargeView',{
									rechargeLevel:'2'
					...
					items : [{
								...
								text : '已确认充值清单',
								//disabled : isGranted('investmentAccountView')? false: true,
								iconCls : 'btn-tree-recharge81-desktop',
								scope : this,
								handler : function() {
									App.clickTopTab('confirmRechargeView',{
									rechargeLevel:'3'
