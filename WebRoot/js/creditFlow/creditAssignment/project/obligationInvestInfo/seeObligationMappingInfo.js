//seeObligationMappingInfo
seeObligationMappingInfo = Ext.extend(Ext.Window, {
	unid:null,
	idDefinition:null,
	obligationId:null,
	// 构造函数
	...
	constructor : function(_cfg) {
		...
		seeObligationMappingInfo.superclass.constructor.call(this, {
					id : 'seeObligationMappingInfo'+this.unid,
					layout : 'fit',
					items : [{
								xtype : 'fieldset',
								title : '债权产品信息',
	...
	initUIComponents : function() {
		...
		if (this.obligationId  != null && this.obligationId  != 'undefined') {
			...
			this.formPanel.loadData({
						url : __ctxPath + "/obligation/project/getObObligationProject.do?id="+ this.obligationId ,
						root : 'data',
