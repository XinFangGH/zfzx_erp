 ...
 * @createtime:
 */
BpPerFinanceApplyView = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpPerFinanceApplyView.superclass.constructor.call(this, {
							id : 'BpPerFinanceApplyView',
							title : '非注册用户申请处理',
							region : 'center',
							layout : 'border',
							items : [this.tabpanel]
			...
			initUIComponents : function() {
				...
				// 初始化搜索条件Panel
				var itemschange=[
								 	new BpPerApplyNotAccepted({tabflag:'BpPerApplyNotAccepted',type:this.type}),
								 	new BpPerApplyAccepted({tabflag:'BpPerApplyAccepted',type:this.type}),
								 	new BpPerApplyUserOfficialUser({tabflag:'BpPerApplyUserOfficialUser',type:this.type}),
								 	new BpPerApplyUserRejected({tabflag:'BpPerApplyUserRejected',type:this.type})
